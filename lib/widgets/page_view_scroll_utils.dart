...
class PageViewScrollUtils {
  ...
  bool handleNotification(ScrollNotification notification) {
    if (notification is UserScrollNotification) {
      // print('notification.direction == ScrollDirection.reverse:${notification.direction == ScrollDirection.reverse}');
      // print('tabController.index == tabController.length - 1:${tabController.index == tabController.length - 1}');
